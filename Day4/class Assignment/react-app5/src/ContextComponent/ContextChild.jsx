...
import { deleteProduct, getOneProduct, getProducts, pathProduct, postProduct } from '../APIServiceLayer/APIRequests'
const ContextChild = () => {
...
let data = useContext(contextAPI)
  ...
  <button onClick={()=>{    deleteProduct("7bfFoRAO1vU")  }}>Delete Product</button>
  <button onClick={()=>{    getOneProduct("7bfFoRAO1vU")  }}>Get One Product</button> 
